...
export default function ProductDetailScreen() {
    ...
    const renderImageCarousel = () => (
        <View style={styles.carouselContainer}>
            ...
            <View style={styles.viewLabelContainer}>
                <Text style={[styles.viewLabelText, { color: colors.text, backgroundColor: colors.surface }]}>
                ...
                {(product.productViews || []).map((view: any, index: number) => (
                    ...
                    >
                        <View style={[
                            ...
                            currentImageIndex === index && { borderColor: colors.text }
                        ]}>
                        ...
                        <Text style={[
                            ...
                            currentImageIndex === index && { color: colors.text, fontWeight: '700' }
                        ]}>
                            {view.label}
                        </Text>
                    </TouchableOpacity>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={styles.imageSlide}>
                            <View style={[styles.mainImageCircle, { backgroundColor: colors.surface }]}>
            ...
            {product.colors.map((color: string, index: number) => (
                <TouchableOpacity
                    ...
                    style={[
                        ...
                        selectedColor === index && [styles.colorOptionSelected, { borderColor: colors.text }]
                    ]}
    ...
    const renderDimensions = () => (
        <View style={[styles.dimensionsContainer, { backgroundColor: colors.background }]}>
            <View style={styles.dimensionItem}>
                <View style={[styles.dimensionIcon, { backgroundColor: colors.surface, borderColor: colors.border }]}>
                    <Ionicons name="resize-outline" size={20} color={colors.text} />
                </View>
                <Text style={[styles.dimensionValue, { color: colors.text }]}>{product.dimensions.height}</Text>
            </View>
            <View style={styles.dimensionItem}>
                <View style={[styles.dimensionIcon, { backgroundColor: colors.surface, borderColor: colors.border }]}>
                    <Ionicons name="scan-outline" size={20} color={colors.text} />
                </View>
                <Text style={[styles.dimensionValue, { color: colors.text }]}>{product.dimensions.width}</Text>
            </View>
            <View style={styles.dimensionItem}>
                <View style={[styles.dimensionIcon, { backgroundColor: colors.surface, borderColor: colors.border }]}>
                    <Ionicons name="cube-outline" size={20} color={colors.text} />
                </View>
                <Text style={[styles.dimensionValue, { color: colors.text }]}>{product.dimensions.depth}</Text>
            </View>
            <View style={styles.dimensionItem}>
                <View style={[styles.dimensionIcon, { backgroundColor: colors.surface, borderColor: colors.border }]}>
                    <Ionicons name="barbell-outline" size={20} color={colors.text} />
                </View>
                <Text style={[styles.dimensionValue, { color: colors.text }]}>{product.dimensions.weight}</Text>
            </View>
        </View>
    );

    const renderDeliverySection = () => (
        <View style={[styles.deliverySection, { backgroundColor: colors.surface }]}>
            <Text style={[styles.sectionTitle, { color: colors.text }]}>Check Delivery</Text>
            <Text style={styles.deliverySubtitle}>Enter pincode to check delivery date / pickup</Text>

            <View style={styles.pincodeContainer}>
                <TextInput
                    style={[styles.pincodeInput, { backgroundColor: colors.surfaceSecondary, color: colors.text }]}
                    placeholder="Pincode"
                ...
                />
                <TouchableOpacity style={[styles.checkButton, { backgroundColor: colors.primary }]}>
                    <Text style={[styles.checkButtonText, { color: colors.primaryText }]}>Check</Text>
                </TouchableOpacity>
            </View>

            <View style={styles.deliveryOptions}>
                <View style={styles.deliveryOption}>
                    <View style={[styles.deliveryIconCircle, { backgroundColor: colors.surfaceSecondary }]}>
                        <Ionicons name="car-outline" size={24} color={colors.text} />
                    </View>
                    <Text style={[styles.deliveryOptionText, { color: colors.text }]}>Free</Text>
                    <Text style={[styles.deliveryOptionText, { color: colors.text }]}>Delivery</Text>
                </View>
                <View style={styles.deliveryOption}>
                    <View style={[styles.deliveryIconCircle, { backgroundColor: colors.surfaceSecondary }]}>
                        <Ionicons name="cash-outline" size={24} color={colors.text} />
                    </View>
                    <Text style={[styles.deliveryOptionText, { color: colors.text }]}>Cash</Text>
                    <Text style={[styles.deliveryOptionText, { color: colors.text }]}>On</Text>
                    <Text style={[styles.deliveryOptionText, { color: colors.text }]}>Delivery</Text>
                </View>
                <View style={styles.deliveryOption}>
                    <View style={[styles.deliveryIconCircle, { backgroundColor: colors.surfaceSecondary }]}>
                    ...
                    <Text style={[styles.deliveryOptionText, { color: colors.text }]}>21 days</Text>
                    <Text style={[styles.deliveryOptionText, { color: colors.text }]}>Return</Text>
                </View>
            </View>
        </View>
    );
    ...
    const renderSimilarProducts = () => (
        <View style={styles.similarSection}>
            <View style={styles.similarHeader}>
                <Text style={[styles.similarTitle, { color: colors.text }]}>Similar Products</Text>
                <TouchableOpacity>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                {similarProducts.map((item) => (
                    ...
                    >
                        <View style={[styles.similarImageContainer, { backgroundColor: colors.surfaceSecondary }]}>
                            <Image source={item.image} style={styles.similarImage} resizeMode="contain" />
                            <TouchableOpacity style={[styles.similarAddButton, { backgroundColor: colors.primary }]}>
                                <Ionicons name="bag-add" size={18} color={colors.primaryText} />
                            </TouchableOpacity>
                        </View>
                        <Text style={[styles.similarName, { color: colors.text }]} numberOfLines={1}>{item.name}</Text>
                        <Text style={styles.similarDesc} numberOfLines={1}>{item.description}</Text>
                        <View style={styles.similarPriceRow}>
                            <View style={styles.similarPrices}>
                                <Text style={[styles.similarPrice, { color: colors.text }]}>${item.price}</Text>
                                <Text style={styles.similarOldPrice}>${item.oldPrice}</Text>
                            </View>
                            <View style={styles.similarRating}>
                                <Ionicons name="star" size={12} color="#FFB800" />
                                <Text style={[styles.similarRatingText, { color: colors.text }]}>{item.rating}</Text>
                            </View>
                        </View>
                    </TouchableOpacity>
                ))}
        ...
        <View style={[styles.container, {backgroundColor: colors.background}]}>
                ...
                <View style={styles.headerRight}>
                    ...
                    >
                        <Ionicons
                            ...
                            size={24}
                            color={isFavorite(product.id) ? "#FF4444" : colors.text}
                        />
                    </TouchableOpacity>
                </View>
            </View>
            ...
            >
                ...
                <View style={styles.productInfo}>
                    ...
                    <View style={styles.priceQuantityRow}>
                        <View style={styles.priceContainer}>
                            <Text style={[styles.currentPrice, { color: colors.text }]}>${product.price.toFixed(2)}</Text>
                ...
                <View style={styles.detailsSection}>
                    ...
                    <Text style={styles.detailsText}>
                        ...
                        ...{' '}
                        <Text
                            style={[styles.readMoreText, { color: colors.text }]}
                ...
                {/* Write Review */}
                <TouchableOpacity
                    style={[styles.writeReviewButton, { borderColor: colors.border }]}
                    onPress={() => setShowReviewModal(true)}
                >
                    <Ionicons name="add" size={20} color={colors.text} />
                    <Text style={[styles.writeReviewText, { color: colors.text }]}>Write Your Review</Text>
                </TouchableOpacity>

                {/* Reviews List */}
                <View style={[styles.reviewsSection, { backgroundColor: isDarkMode ? colors.surfaceSecondary : '#F8F9FA' }]}>
                    <View style={styles.reviewsHeader}>
                        <Text style={[styles.reviewsTitle, { color: colors.text }]}>{reviews.length} Reviews</Text>
                        <TouchableOpacity>
                            <Text style={styles.viewAllText}>View all</Text>
                        </TouchableOpacity>
                    </View>
                        ...
                        <View key={review.id} style={[styles.reviewCard, { backgroundColor: colors.surface }]}>
                            <View style={styles.reviewHeader}>
                                <View style={styles.reviewUserInfo}>
                                    <View style={[styles.reviewAvatar, { backgroundColor: colors.surfaceSecondary }]}>
                                ...
                                <View style={[styles.reviewRatingBadge, { backgroundColor: isDarkMode ? colors.surfaceSecondary : '#FFF9E6' }]}>
            ...
            <View style={[styles.bottomBar, { backgroundColor: colors.background, borderTopColor: colors.border }]}>
                <TouchableOpacity style={[styles.addToCartButton, { backgroundColor: colors.primary }]} onPress={handleAddToCart}>
                    ...
                    <Text style={[styles.addToCartText, { color: colors.primaryText }]}>Add to cart</Text>
                    <Text style={[styles.cartPrice, { color: colors.primaryText }]}>${totalPrice}</Text>
                </TouchableOpacity>
            </View>
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <Text style={[styles.successTitle, { color: colors.text }]}>Added to Cart!</Text>
                        <Text style={styles.successMessage}>{addedProductName}</Text>

                        <View style={styles.modalButtons}>
                            <TouchableOpacity
                                style={[styles.continueButton, { backgroundColor: colors.surfaceSecondary }]}
                                onPress={() => setShowSuccessModal(false)}
                            >
                            ...
                            >
                                <Text style={[styles.viewCartButtonText, { color: colors.primaryText }]}>View Cart</Text>
                            </TouchableOpacity>
                        </View>
                    </Animated.View>
                </TouchableOpacity>
                ...
                >
                    <View style={[styles.reviewModalContent, { backgroundColor: colors.surface }]}>
                        <View style={styles.reviewModalHeader}>
                            <Text style={[styles.reviewModalTitle, { color: colors.text }]}>Write Your Review</Text>
                        ...
                        >
                            ...
                            <View style={styles.reviewTextSection}>
                                <Text style={[styles.reviewTextLabel, { color: colors.text }]}>Your Review</Text>
                                <TextInput
                                    style={[styles.reviewTextInput, { backgroundColor: colors.surfaceSecondary, borderColor: colors.border, color: colors.text }]}
                            ...
                            <View style={styles.reviewModalButtons}>
                                <TouchableOpacity
                                    style={[styles.cancelReviewButton, { backgroundColor: colors.surfaceSecondary }]}
                                    onPress={() => {
                                        setShowReviewModal(false);
                                        setReviewText('');
                                        setUserRating(5);
                                ...
                                >
                                    <Text style={[styles.cancelReviewText, { color: colors.text }]}>Cancel</Text>
                                </TouchableOpacity>
                                ...
                                >
                                    <Text style={[styles.submitReviewText, { color: colors.primaryText }]}>Submit Review</Text>
                                </TouchableOpacity>
                            </View>
                        </ScrollView>
                    </View>
